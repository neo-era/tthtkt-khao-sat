# Khảo sát chiếu sáng & mảng xanh công cộng — LAVIPCO

Ứng dụng web khảo sát hiện trường (chạy trên điện thoại) để rà soát, đề xuất **bổ sung hệ thống chiếu sáng công cộng và mảng xanh** tại **107 vị trí** trụ dừng / nhà chờ xe buýt và khu vực người đi bộ thuộc khu vực trung tâm TP. Hồ Chí Minh.
...
2. Đặt tên, ví dụ `lavipco-khao-sat` → chọn **Public** → **Create repository**.
...
6. Chờ 1–2 phút, tải lại trang Settings → Pages sẽ hiện đường dẫn:
   `https://<tên-tài-khoản>.github.io/lavipco-khao-sat/`
...
git init
git add .
git commit -m "Khởi tạo app khảo sát chiếu sáng & mảng xanh"
git branch -M main
git remote add origin https://github.com/<tên-tài-khoản>/lavipco-khao-sat.git
...
1. Tạo một **Google Sheet** mới (đặt tên tùy ý, ví dụ "Khảo sát CS&MX 2026").
...
4. Trên thanh chọn hàm, chọn **`setupSheet`** → bấm **Run**.
   ...
   - Chạy xong, sheet "KhaoSat" sẽ có sẵn 19 cột tiêu đề định dạng đẹp.
...
3. Chạm một vị trí → bấm **Định vị** để lấy tọa độ GPS, chọn hiện trạng chiếu sáng / mảng xanh, nhập đề xuất, mức ưu tiên, chụp ảnh, ghi chú → **Lưu khảo sát điểm này**.
4. Dữ liệu được **lưu ngay trên điện thoại** (đóng app mở lại không mất).
5. Khi có mạng: bấm **Xuất / Đồng bộ** → **Đồng bộ lên Google Sheets**, hoặc **Tải CSV** để mở bằng Excel.
...
*Công ty TNHH Kỹ Nghệ Lâm Việt Phát (LAVIPCO) — Tài liệu nội bộ phục vụ công tác khảo sát hạ tầng chiếu sáng đô thị.*
