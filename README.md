...
| **Bản đồ vị trí** | `map.html` | Trang riêng: vẽ toàn bộ điểm có tọa độ lên bản đồ, popup xem thông tin từng vị trí, nút định vị chỗ mình đang đứng kèm khoảng cách tới từng điểm. Cần có mạng. |
